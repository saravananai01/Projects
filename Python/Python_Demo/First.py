...
# print("உங்கள்  அனைவரும் The Great Kirikalan Show-விற்கு வரவேற்க்கிறேன்")
...
class Meta:
    def __init__(self):
        print("Welcome To META Product's")
    
    def Access(self):
        print("I Need META I'd,Password")

    def login(self):
        a=input("Enter Your Phone_number :")
        b=input("Enter Your Password     :")
    
    def facebook(self):
        print("You Access The Facebook")

    def Messenger(self):
        print("You Access The Messenger")
    
    def instagram(self):
        print("You Access The Instagram")

    def WhatsApp(self):
         print("You Access The WhatsApp")
...
class facebook(Meta):
    ...
    def post(self):
        print("Like In Your Post")

    def story(self):        
        print("Watch And Like Your Stroy")

    def videos(self):
        print("Watching Some Video's")

class Messenger(Meta):
    ...
    def Messege(self):
        print("Texting Frinds & stranger")

    def vid_pht(self):
        print("Sending For Video's & Photo's")

class instagram(Meta):
    ...
    def pst_rels(self):
        print("Uploding For Post & Reels")

    def share(self):
        print("Sharing with Post & Reels In Your Friends")

    def link(self):
        print("Get for Some Movie's Link's")
...
class WhatsApp(Meta):
    ...
    def chat(self):
        print("You Can Chat With Friends & Family")

    def send(self):
        print("You Can Send With Doc & Pht & Vid & Lnk")

    def call(self):
        print("You Can Call For Any Contry Person's")
